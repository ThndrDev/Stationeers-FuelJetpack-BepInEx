...
namespace FuelJetpack.Scripts
{
    public class FJ
    {
        public static void EjectInternalAtmosphere(Jetpack jetpack)
        {
            ...
            if (jetpack.WorldAtmosphere == null || jetpack.WorldAtmosphere.Mode == Atmosphere.AtmosphereMode.Global)
            {
                jetpack.WorldAtmosphere = jetpack.GridController.AtmosphericsController.CloneGlobalAtmosphere(jetpack.WorldGrid, 0L, true);
            }
